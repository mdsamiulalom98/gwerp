            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="quick_btn">
                                <a href="{{ route('warnings.index') }}"><i class="ti ti-device-desktop-check"></i>
                                    Manage</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('warnings.update') }}" method="POST" class="row"
                                            ...
                                            <select class="form-control form-select" id="warning_by" name="warning_by"
                                                ...
                                                @foreach ($employees as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ $edit_data->warning_by == $value->id ? 'selected' : '' }}>
                                                        {{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control form-select" id="warning_to" name="warning_to"
                                                ...
                                                <option value="">Select..</option>
                                                @foreach ($employees as $key => $value)
                                                    <option value="{{ $value->id }}"{{ $edit_data->warning_to == $value->id ? 'selected' : '' }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('warning_to')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('title') is-invalid @enderror "
                                                name="subject" value="{{ $edit_data->subject ?? old('subject') }}" id="subject" required>
                                            @error('subject')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
