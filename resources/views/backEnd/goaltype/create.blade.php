...
@section('title','Goal Type Create')
@section('content')
		...
		<div class="page-header">
			<div class="page-block">
			    <div class="row align-items-center justify-content-between">
			    	...
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('goaltypes.index')}}"><i class="ti ti-plus"></i> Manage</a>
                        </div>
			    	</div>
			    </div>
			</div>
		    ...
		    <div class="row">
    			...
    			<div class="col-sm-9">
    				<div class="card">
    					...
    					<div class="card-body">
    						<h5 class="title-2">Goal Type Create</h5>
    						<form action="{{ route('goaltypes.store') }}" method="POST" class="row"
