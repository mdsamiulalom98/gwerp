            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="quick_btn">
                                <a href="{{ route('holidays.index') }}"><i class="ti ti-device-desktop-check"></i>
                                    Manage</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <h6> Holiday Create</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('holidays.store') }}" method="POST" class="row"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                id="occasion" placeholder="Occasion" value="{{ old('occasion') }}"
                                                required>
                                            @error('occasion')
