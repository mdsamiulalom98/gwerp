...
@section('title','Allowance Type Manage')
@section('content')
	             		...
	             		<h4 class="m-b-10">Allowance Type</h4>
						   ...
						   <ul class="breadcrumb">
							  ...
							  <li class="breadcrumb-item active">
							    Allowance Type Manage
							  </li>
						   </ul>
				    </div>
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('allowancetypes.create')}}"><i class="ti ti-plus"></i> New</a>
                        </div>
			    	</div>
			    </div>
			</div>
		...
		<div class="page-content">
		    <div class="row">
    			...
    			<div class="col-sm-9">
    				<div class="card">
    					<div class="card-body">
    						<h5 class="title-2">Allowance Type Manage</h5>
...
<script>
   $(function(){
    var table = $('#data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax:"{{route('allowancetypes.index')}}",
        pageLength: 50,
