                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Subcategory Manage</h4>
                            </div>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto">
                            <div class="quick_btn">
                                <a href="{{ route('subcategories.index') }}"><i class="ti ti-device-desktop-check"></i>
                                    Manage</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('subcategories.update') }}" method="POST" class="row"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control form-select" id="category_id" name="category_id"
                                                ...
                                                @foreach ($categories as $key => $value)
                                                    <option {{ $value->id == $edit_data->category_id ? 'selected' : '' }}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="name" class="form-label">Subcategory Name
                                                <span>*</span></label>
