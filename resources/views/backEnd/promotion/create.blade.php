                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <h6> Promotion Create</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('promotions.store') }}" method="POST" class="row"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="promotion_title" value="{{ old('promotion_title') }}" id="promotion_title" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            <label for="promotion_date" class="form-label">Promotion Date <span>*</span></label>
                                            <input type="text"
                                                class="form-control @error('title') is-invalid @enderror flatpickr"
                                                name="promotion_date" value="{{ old('promotion_date') }}" id="promotion_date" required>
