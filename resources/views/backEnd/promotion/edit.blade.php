            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="quick_btn">
                                <a href="{{ route('promotions.index') }}"><i class="ti ti-device-desktop-check"></i> Manage</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <h6>Promotion Edit</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('promotions.update') }}" method="POST" class="row"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control form-select" id="designation_id" name="designation_id"
                                                required>
                                                <option value="">Select..</option>
                                                @foreach ($designations as $key => $value)
                                                    <option value="{{ $value->id }}" {{ $value->id == $edit_data->designation_id ? 'selected' : '' }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            <label for="promotion_title" class="form-label">Promotion Title
                                                <span>*</span></label>
                                            <input type="text"
                                                class="form-control @error('title') is-invalid @enderror flatpickr"
                                                name="promotion_title" value="{{ $edit_data->promotion_title ?? old('promotion_title')  }}" id="promotion_title" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            <label for="promotion_date" class="form-label">Promotion End Date <span>*</span></label>
                                            <input type="text"
                                                class="form-control @error('title') is-invalid @enderror flatpickr"
                                                name="promotion_date" value="{{ $edit_data->promotion_date ?? old('promotion_date') }}" id="promotion_date" required>
