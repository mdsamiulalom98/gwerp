                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="manager" value="{{ old('manager') }}" id="manager" required>
                                            @error('manager')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" class="form-control @error('opening_hours') is-invalid @enderror "
                                                name="opening_hours" value="{{ old('opening_hours') }}" id="opening_hours"
                                                required>
                                            @error('opening_hours')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" class="form-control @error('closing_hours') is-invalid @enderror "
                                                name="closing_hours" value="{{ old('closing_hours') }}" id="closing_hours"
                                                required>
                                            @error('closing_hours')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="capacity" value="{{ old('capacity') }}" id="capacity" required>
                                            @error('capacity')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
