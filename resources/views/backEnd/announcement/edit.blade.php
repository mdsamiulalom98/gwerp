                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Announcement Edit</h4>
                            </div>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto">
                            <div class="quick_btn">
                                <a href="{{ route('announcements.index') }}"><i class="ti ti-device-desktop-check"></i> Manage</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <h6>Announcement Edit</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('announcements.update') }}" method="POST" class="row"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" value="{{ $edit_data->title ?? old('title') }}"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control form-select" id="branch_id" name="branch_id"
                                                ...
                                                @foreach ($branchs as $key => $value)
                                                    <option {{ $value->id == $edit_data->branch_id  ? 'selected' : ''}} value="{{ $value->id }}">{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('branch_id')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control select2 form-select" multiple id="department_id" name="department_id[]" data-select="select2"
                                                ...
                                                @foreach ($departments as $key => $value)
                                                    <option @selected($selectedDepartments->contains('department_id', $value->id)) value="{{ $value->id }}">{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('department_id')
