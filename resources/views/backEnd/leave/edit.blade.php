    ...
    <section class="wsit-container">
        <div class="wsit-content">
            ...
            <div class="page-content">
                <form action="{{ route('leaves.update') }}" method="POST" class="row" data-parsley-validate=""
                                    ...
                                    <div class="row">
                                                ...
                                                <select class="form-control form-select" id="employee_id"
                                                    ...
                                                    @foreach ($employees as $employee)
                                                        <option value="{{ $employee->id }}"
                                                            {{ $edit_data->employee_id == $employee->id ? 'selected' : '' }}>
                                                            {{ $employee->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select class="form-control form-select" id="leave_type" name="leave_type">
                                                    ...
                                                    @foreach ($leave_types as $type)
                                                        <option value="{{ $type->id }}"
                                                            {{ $edit_data->leave_type == $type->id ? 'selected' : '' }}>
                                                            {{ $type->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="start_date" value="{{ $edit_data->start_date ?? old('start_date') }}" id="start_date"
                                                    required="">
                                                @error('start_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="end_date" value="{{ $edit_data->end_date ?? old('end_date') }}" id="end_date"
                                                    required="">
                                                @error('end_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control @error('reason') is-invalid @enderror" name="reason" id="reason" required="">{{ $edit_data->reason }}</textarea>
                                                @error('reason')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control @error('remarks') is-invalid @enderror" name="remarks" id="remarks" required="">{{ $edit_data->remarks }}</textarea>
                                                @error('remarks')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <select class="form-control form-select" id="status"
                                                    ...
                                                    <option value="">Select Status</option>
                                                        <option value="pending"
                                                            {{ $edit_data->status == 'pending' ? 'selected' : '' }}>
                                                            Pending
                                                        </option>
                                                        <option value="approve"
                                                            {{ $edit_data->status == 'approve' ? 'selected' : '' }}>
                                                            Approve
                                                        </option>
                                                        <option value="reject"
                                                            {{ $edit_data->status == 'reject' ? 'selected' : '' }}>
                                                            Reject
                                                        </option>
                                                </select>
                                                @error('status')
