                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('trips.update') }}" method="POST" class="row"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="purpose_of_visit" id="purpose_of_visit" value="{{ $edit_data->purpose_of_visit }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" value="{{ $edit_data->place_of_visit }}"
                                                class="form-control @error('place_of_visit') is-invalid @enderror"
