...
@section('title','Deduction Option Create')
@section('content')
	             		...
	             		<h4 class="m-b-10">Deduction Option</h4>
						   ...
						   <ul class="breadcrumb">
							  ...
							  <li class="breadcrumb-item active">
							    Deduction Option Create
							  </li>
						   </ul>
				    </div>
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('deductionoptions.index')}}"><i class="ti ti-plus"></i> Manage</a>
                        </div>
			    	</div>
			    </div>
			</div>
		    ...
		    <div class="row">
    			...
    			<div class="col-sm-9">
    				<div class="card">
    					...
    					<div class="card-body">
    						<h5 class="title-2">Deduction Option Create</h5>
    						<form action="{{ route('deductionoptions.store') }}" method="POST" class="row"
