...
@section('title','Loan Option Manage')
@section('content')
		...
		<div class="page-header">
			<div class="page-block">
			    <div class="row align-items-center justify-content-between">
			    	...
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('loanoptions.create')}}"><i class="ti ti-plus"></i> New</a>
                        </div>
			    	</div>
			    </div>
			</div>
		...
		<div class="page-content">
		    <div class="row">
    			...
    			<div class="col-sm-9">
    				<div class="card">
    					<div class="card-body">
    						<h5 class="title-2">Loan Option Manage</h5>
