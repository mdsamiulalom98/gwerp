...
@section('title','Performance Type Create')
@section('content')
			    ...
			    <div class="row align-items-center justify-content-between">
			    	<div class="col-auto">
				    	<div class="page-header-title">
	             		<h4 class="m-b-10">Performance Type</h4>
	            		</div>
						   <ul class="breadcrumb">
			    	...
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('performancetypes.index')}}"><i class="ti ti-plus"></i> Manage</a>
                        </div>
			    	</div>
			    </div>
			</div>
		    ...
		    <div class="row">
    			...
    			<div class="col-sm-9">
    				<div class="card">
    					...
    					<div class="card-body">
    						<h5 class="title-2">Performance Type Create</h5>
    						<form action="{{ route('performancetypes.store') }}" method="POST" class="row"
