            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="quick_btn">
                                <a href="{{ route('suppliers.index') }}"><i class="ti ti-device-desktop-check"></i> Manage</a>
                            </div>
                        </div>
                    </div>
                </div>
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="contact_number" value="{{ old('contact_number') }}" id="contact_number" required>
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="contact_person" value="{{ old('contact_person') }}" id="contact_person" required>
