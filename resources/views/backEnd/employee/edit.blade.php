    ...
    <section class="wsit-container">
        <div class="wsit-content">
            ...
            <div class="page-content">
                <form action="{{ route('employees.update') }}" method="POST" class="row" data-parsley-validate=""
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $edit_data->name ?? old('name') }}" id="name"
                                                    required="">
                                                @error('name')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $edit_data->phone ?? old('phone') }}" id="phone"
                                                    required="">
                                                @error('phone')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="email"
                                                    ...
                                                    value="{{ $edit_data->email ?? old('email') }}" id="email"
                                                    required="">
                                                @error('email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ $edit_data->dob ? date('Y-m-d', strtotime($edit_data->dob)) : old('dob') }}"
                                                    id="dob" required="">
                                                @error('dob')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="radio" class="form-check-input" id="male" name="gender"
                                                    {{ $edit_data->gender == 'male' ? 'checked' : '' }} value="male">
                                                <label for="male"
                                                    style="margin-right: 10px;display: inline-block;">Male</label>
                                                <input type="radio" class="form-check-input" id="female" name="gender"
                                                    {{ $edit_data->gender == 'female' ? 'checked' : '' }} value="female">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $edit_data->passport_country ?? old('passport_country') }}"
                                                    id="passport_country">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="passport_no"
                                                    value="{{ $edit_data->passport_no ?? old('passport_no') }}"
                                                    id="passport_no">
                                                @error('passport_no')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="country" value="{{ $edit_data->country ?? old('country') }}"
                                                    id="country">
                                                @error('country')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="city" value="{{ $edit_data->city ?? old('city') }}"
                                                    id="city">
                                                @error('city')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="zip_code" value="{{ $edit_data->zip_code ?? old('zip_code') }}"
                                                    id="zip_code">
                                                @error('zip_code')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" required="">{{ $edit_data->address ?? '' }}</textarea>
                                                @error('address')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-3">
                                                    <img id="blah1"
                                                        src="{{ asset($edit_data->certificate ?? 'public/backEnd/assets/images/default.png') }}"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-3">
                                                    <img id="blah2"
                                                        src="{{ asset($edit_data->cv ?? 'public/backEnd/assets/images/default.png') }}"
                                                        width="120" class="rounded" height="100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-3">
                                                    <img id="blah3"
                                                        src="{{ asset($edit_data->photo ?? 'public/backEnd/assets/images/default.png') }}"
                                                        width="120" class="rounded" height="100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-3">
                                                    <img id="blah4"
                                                        src="{{ asset($edit_data->result ?? 'public/backEnd/assets/images/default.png') }}"
                                                        width="120" class="rounded" height="100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="bank_holder"
                                                    value="{{ $edit_data->bank_holder ?? old('bank_holder') }}"
                                                    id="bank_holder">
                                                @error('bank_holder')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="bank_account"
                                                    value="{{ $edit_data->bank_account ?? old('bank_account') }}"
                                                    id="bank_account">
                                                @error('bank_account')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="bank_name"
                                                    value="{{ $edit_data->bank_name ?? old('bank_name') }}"
                                                    id="bank_name">
                                                @error('bank_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="bank_branch"
                                                    value="{{ $edit_data->bank_branch ?? old('bank_branch') }}"
                                                    id="bank_branch">
                                                @error('bank_branch')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="bank_routing"
                                                    value="{{ $edit_data->bank_routing ?? old('bank_routing') }}"
                                                    id="bank_routing">
                                                @error('bank_routing')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="employee_id"
                                                    value="{{ $edit_data->employee_id ?? $employeeId }}"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control form-select" id="designation_id"
                                                    ...
                                                    @foreach ($designations as $key => $value)
                                                        <option
                                                            {{ $edit_data->designation_id == $value->id ? 'selected' : '' }}
                                                            value="{{ $value->id }}">{{ $value->name }}</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="joining_date"
                                                    value="{{ $edit_data->joining_date ? date('Y-m-d', strtotime($edit_data->joining_date)) : old('joining_date') }}"
                                                    id="joining_date">
                                                @error('joining_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control form-select" required="required"
                                                    ...
                                                    <option selected="selected" value="8">driving student</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" placeholder="Enter Employee Code"
                                                    ...
                                                    name="employee_code"
                                                    value="{{ $edit_data->employee_code ?? old('employee_code') }}"
                                                    id="employee_code">
                                                @error('employee_code')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="number" value="{{ $edit_data->number ?? old('number') }}"
                                                    id="number">
                                                @error('number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="hour_per_day"
                                                    value="{{ $edit_data->hour_per_day ?? old('hour_per_day') }}"
                                                    id="hour_per_day">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="annual_salary"
                                                    value="{{ $edit_data->annual_salary ?? old('annual_salary') }}"
                                                    id="annual_salary">
                                                @error('annual_salary')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="days_per_week"
                                                    value="{{ $edit_data->days_per_week ?? old('days_per_week') }}"
                                                    id="days_per_week">
                                                @error('days_per_week')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="fixed_salary"
                                                    value="{{ $edit_data->fixed_salary ?? old('fixed_salary') }}"
                                                    id="fixed_salary">
                                                @error('fixed_salary')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="hour_per_month"
                                                    value="{{ $edit_data->hour_per_month ?? old('hour_per_month') }}"
                                                    id="hour_per_month">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="rate_per_day"
                                                    value="{{ $edit_data->rate_per_day ?? old('rate_per_day') }}"
                                                    id="rate_per_day">
                                                @error('rate_per_day')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="days_per_month"
                                                    value="{{ $edit_data->days_per_month ?? old('days_per_month') }}"
                                                    id="days_per_month">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="rate_per_hour"
                                                    value="{{ $edit_data->rate_per_hour ?? old('rate_per_hour') }}"
                                                    id="rate_per_hour">
                                                @error('rate_per_hour')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
